...
public class TestingDatabaseConfig {
    ...
    private static final String DB_NAME =
            Objects.requireNonNullElse(System.getenv("DB_NAME"), "libraryTest");
    private static final String DB_USERNAME =
            Objects.requireNonNullElse(System.getenv("DB_USERNAME"), "postgres");
    private static final String DB_PASSWORD =
            Objects.requireNonNullElse(System.getenv("DB_PASSWORD"), "111");
    ...
    public void setup() {
        if (System.getenv("DB_HOST") == null) {
            ...
            adminDataSource.setUrl("jdbc:postgresql://localhost:5432/library");
            adminDataSource.setUsername("postgres");
            adminDataSource.setPassword("111");
    ...
    public DataSource dataSource() throws SQLException {
        ...
        ScriptUtils.executeSqlScript(dataSource.getConnection(), new ClassPathResource("libraryTest"));
